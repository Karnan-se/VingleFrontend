          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#">Our Courses</Link></li>
                <li><Link href="#">Our Testimonials</Link></li>
                <li><Link href="#">Our FAQ</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#">Our Goals</Link></li>
              </ul>
            </div>
            <div>
